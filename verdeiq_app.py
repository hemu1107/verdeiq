...
with st.sidebar:
    ...
    st.image(LOGO_URL, width=90) # Slightly smaller width for sidebar
...
if st.session_state.page == "intro":
    ...
    with col2:
        st.image(LOGO_URL, use_container_width=90) # Replaced use_column_width with use_container_width
